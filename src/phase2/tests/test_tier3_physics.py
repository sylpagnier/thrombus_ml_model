...
from src.phase2.train_tier3 import remap_tier2_encoder_weight_to_tier3
from src.phase2.extract_tier3_comsol_data import PatientDataExtractor
...
class TestTier3Physics(unittest.TestCase):
    ...
    def test_kinetics_against_comsol_csv_oracle(self):
        ...
        root = get_project_root()
        oracle_csv = root / "src/phase2/tests/fixtures/oracle_kinetics.csv"
        oracle_txt = root / "src/phase2/tests/fixtures/oracle_kinetics.txt"
    ...
    def test_tier2_to_tier3_encoder_weight_remap_shifts_tail(self):
        ...
        remapped = remap_tier2_encoder_weight_to_tier3(old_weight, target_template)
    ...
    def test_comsol_extracted_graph_physics_regression(self):
        ...
        # Keep legacy strictness on the first interval while also adding trajectory-wide gating.

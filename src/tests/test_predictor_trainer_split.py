"""Tests for unified anchor/physics train/val split (``split_anchor_physics``)."""

import torch

from src.training.train_kinematics_predictor import split_anchor_physics
...
def test_split_anchor_physics_counts_and_ratio():
    ...
    assert split["n_anchors"] == 9
    assert split["n_physics"] == 18

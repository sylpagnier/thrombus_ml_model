...
def objective(trial):
    ...
    dice_weight = trial.suggest_float("dice_weight", 0.0, 5.0)
    focal_weight = trial.suggest_float("focal_weight", 0.0, 5.0)
    ...
    print(f"Trial Final Score: {final_score:.4f}")
    return final_score

if __name__ == "__main__":
    study_name = "curriculum_optimization"
    storage_path = Path("outputs/biochem/optuna_study.db")
    ...
    print("\n[i] Starting 30-minute Optuna Study...")

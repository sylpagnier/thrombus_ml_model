# M3 alignment probe: union TBPTT mask + transport_only ADR + species val (12ep default).

function Set-M3AlignProbeEnv {
    param(
    ...
    # Alignment recipe (post narrowing)
    ...
    Remove-Item Env:\BIOCHEM_ADR_MASK_PER_STEP -ErrorAction SilentlyContinue
}

...
| GNODE 10-12 (predicted kine) | `go_gnode10_*`; `go_gnode11_*` (11a/11b/finish); **`go_gnode12_lane_a.ps1`** (mu unlock + dump + clot); `check_gnode12_lane_a_gate.py`; `_gnode12_env.ps1` |

...
$env:BIOCHEM_K11_DATA_KINE_WEIGHT = "1.0"
...
$env:BIOCHEM_RUN_NOTE = "K11_clot_gate"
if ($OomSafe) {
...
python -m src.training.train_biochem_corrector --new --epochs 12 --save-best --run-name K11_clot_gate
exit $LASTEXITCODE

# M3 narrowing (~90m) experiment env helpers.

function Set-M3NarrowingBaseEnv {
    param(
        [string] $RunNote,
    ...
    $env:BIOCHEM_ADR_RESIDUAL_MODE = "convective_nd"
...
function Clear-M3NarrowingOverrides {
    @(
        "BIOCHEM_ADR_MASK_MODE",
        "BIOCHEM_ADR_EXCLUDE_WALL",
        "BIOCHEM_ADR_RESIDUAL_MODE",
        "BIOCHEM_ADR_SPECIES_SCOPE",
        "BIOCHEM_ADR_FAST_TRANSIENT",
        "BIOCHEM_PASSIVE_ADR_BACKPROP",
        "BIOCHEM_PASSIVE_ADR_WEIGHT",
        "BIOCHEM_PASSIVE_WALL_BACKPROP",
        "BIOCHEM_PASSIVE_WALL_WEIGHT"

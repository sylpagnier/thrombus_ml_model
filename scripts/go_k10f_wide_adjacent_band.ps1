# K10f: K10e with wider wall-adjacent band + stronger adjacent log + weaker bulk penalty.
# Prereq: outputs/kinematics/kinematics_best.pth
#
#   powershell -NoProfile -ExecutionPolicy Bypass -File ".\scripts\go_k10f_wide_adjacent_band.ps1" -Fresh
...
$env:BIOCHEM_RUN_NOTE = "K10f_wide_adjacent_band"
if ($OomSafe) {
...
python -m src.training.train_biochem_corrector --new --epochs 12 --save-best --run-name K10f_wide_adjacent_band
exit $LASTEXITCODE
